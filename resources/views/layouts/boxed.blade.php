@extends('shared.base', ['title' => 'Boxed']) @section('html_attribute') data-layout-width="boxed" data-sidenav-size="on-hover" @endsection @section('styles') @endsection @section('content')
<div class="wrapper">
