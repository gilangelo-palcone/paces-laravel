            ...
            <div class="2xl:w-5/12 md:w-1/2 sm:w-2/3 w-full">
                ...
                <div class="card p-7.5 rounded-2xl">
                    ...
                    <div class="mb-7.5 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-default-400 mx-auto mt-6 mb-4 w-full lg:w-3/4">Let’s get you started. Create your account by entering your details below.</p>
                    </div>
                    <div class="grid lg:grid-cols-2 text-default-400 gap-3">
                        <div>
                            <a class="btn border border-default-300 text-default-900 hover:text-default-400 w-full" href="#!">
                    ...
                    <p class="text-default-400 mt-7.5 text-center">
                        ...
                        <a class="text-primary font-semibold underline underline-offset-4" href="{{ url('/auth/sign-in') }}">Login</a>
                    </p>
                </div>
                <!-- Auth Footer -->
                <p class="text-default-400 mt-7.5 text-center">
