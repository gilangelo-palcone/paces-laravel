@extends('shared.base', ['title' => 'Ajax']) @section('styles') @endsection @section('content')
<div class="wrapper">
    @include('shared.partials.topbar', ['subtitle' => 'Tables', 'title' => 'Ajax']) @include('shared.partials.sidenav')
    <!-- Start Page Content here -->
    <div class="page-content">
        <main>
            @include('shared.partials.page-title', ['subtitle' => 'Tables', 'title' => 'Ajax'])
            <div class="container-fluid">
                <div class="grid grid-cols-1 gap-base">
                    <div class="card">
                        <div class="card-header justify-between">
                            <h4 class="card-title">Example</h4>
                            <a class="group text-primary font-semibold hover:text-primary-hover" href="https://datatables.net/examples/ajax/" target="_blank">
                                View Docs
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-wrapper">
                                <table class="table-striped dt-responsive table align-middle" id="datatables-ajax">
...
@include('shared.partials.customizer') @endsection @section('scripts') @vite(['resources/js/pages/datatables-ajax.js']) @endsection
