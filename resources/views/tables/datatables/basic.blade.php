@extends('shared.base', ['title' => 'Datatables basic']) @section('styles') @endsection @section('content')
<div class="wrapper">
    @include('shared.partials.topbar', ['subtitle' => 'Tables', 'title' => 'Datatables basic']) @include('shared.partials.sidenav')
    <!-- Start Page Content here -->
    <div class="page-content">
        <main>
            @include('shared.partials.page-title', ['subtitle' => 'Tables', 'title' => 'Datatables basic'])
            <div class="container-fluid">
                <div class="grid grid-cols-1 gap-base">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Basic DataTable</h4>
                            <a class="group text-primary font-semibold hover:text-primary-hover" href="https://datatables.net/examples/basic_init/zero_configuration.html" target="_blank">
                                View Docs
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-wrapper">
                                <table class="table table-striped" data-tables="basic">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="group text-primary font-semibold hover:text-primary-hover" href="https://datatables.net/examples/advanced_init/complex_header.html" target="_blank">
                                View Docs
                                <i class="iconify tabler--arrow-right group-hover:translate-x-1 transform-3d transition-transform duration-300 align-middle text-base"></i>
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="table-wrapper">
                                <table class="table table-bordered" data-tables="basic">
...
@include('shared.partials.customizer') @endsection @section('scripts') @vite(['resources/js/pages/datatables-basic.js']) @endsection
