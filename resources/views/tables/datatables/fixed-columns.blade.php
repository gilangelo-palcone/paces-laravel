@extends('shared.base', ['title' => 'Fixed Columns']) @section('styles') @endsection @section('content')
<div class="wrapper">
    @include('shared.partials.topbar', ['subtitle' => 'Tables', 'title' => 'Fixed Columns']) @include('shared.partials.sidenav')
    <!-- Start Page Content here -->
    <div class="page-content">
        <main>
            @include('shared.partials.page-title', ['subtitle' => 'Tables', 'title' => 'Fixed Columns'])
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-wrapper">
                                <table class="table table-striped stripe align-middle" id="fixed-columns">
...
<!-- Page js -->
@endsection @section('scripts') @vite(['resources/js/pages/datatables-fixed-columns.js']) @endsection
