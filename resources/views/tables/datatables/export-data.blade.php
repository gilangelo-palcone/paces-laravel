@extends('shared.base', ['title' => 'Export Data']) @section('styles') @endsection @section('content')
<div class="wrapper">
    @include('shared.partials.topbar', ['subtitle' => 'Tables', 'title' => 'Export Data']) @include('shared.partials.sidenav')
    <!-- Start Page Content here -->
    <div class="page-content">
        <main>
            @include('shared.partials.page-title', ['subtitle' => 'Tables', 'title' => 'Export Data'])
                ...
                <div class="grid grid-cols-1 gap-base">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-wrapper">
                                <table class="table table-striped" data-tables="export-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class=".-mx-base">
                                <div class="table-wrapper">
                                    <table class="table table-striped" data-tables="export-data-dropdown">
                                        <thead class="thead-sm uppercase text-2xs">
                                            <tr>
                                                <th scope="col">Company</th>
                                                <th scope="col">Symbol</th>
...
@include('shared.partials.customizer') @endsection @section('scripts') @vite(['resources/js/pages/datatables-export-data.js']) @endsection
