@extends('shared.base', ['title' => 'eCommerce Dashboard']) @section('styles') @endsection @section('content')
<div class="wrapper">
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <h3 class="my-5 py-1.25 font-semibold text-xl">
                                                <span data-target="9,754">9,754</span>
                                            </h3>
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <h3 class="my-5 py-1.25 font-semibold text-xl">
                                                $
                                                <span data-target="75.21">75.21</span>
                                                k
                                            </h3>
                                            <p class="text-default-400 text-sm flex items-center gap-3.25">
                                                <span class="text-danger flex items-center gap-1">
                                ...
                                <div class="card-body">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <h3 class="my-5 py-1.25 font-semibold text-xl">
                                                +
                                                <span data-target="25.08">25.08</span>
                                                %
                                            </h3>
                                            <p class="text-default-400 text-sm flex items-center gap-3.25">
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-base h-full">
                            <div class="card h-full">
                                <div class="card-header">
                                    ...
                                    <div>
                                        <a class="btn btn-sm border-default-300 hover:border-default-400 text-default-800 font-semibold" href="#">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mb-1.25">
                                        <span class="badge border border-default-300 text-dark p-1.25 px-2.5 rounded-full text-xs">
                                            <i class="iconify tabler--star-filled text-danger me-1"></i>
                                            POOR SALES
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <ul class="hs-dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger" href="#">
                                                    <i class="iconify tabler--archive"></i>
                                                    Archive Widget
                                                </a>
                                            </li>
                                        </ul>
                ...
                <div class="grid xl:grid-cols-2 grid-cols-1 gap-base mb-base">
                    ...
                    <div class="card h-full" data-table="" data-table-rows-per-page="6">
                        <div class="card-header">
                            ...
                            <div>
                                <a class="btn btn-sm border-default-300 hover:border-default-400 font-semibold" href="#">
                                    <i class="iconify tabler--cloud-upload"></i>
                                    Export
                                </a>
                                <a class="btn btn-sm bg-light hover:text-primary font-semibold" href="#">
                                    <i class="iconify tabler--download"></i>
                                    Import
                                </a>
                            </div>
                                ...
                                <table class="table table-hover whitespace-nowrap w-full">
                                    <tbody class="text-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-warning/15 text-warning px-2.5 py-1.25 rounded-full text-xs">Low Stock</span>
                                            </td>
                                        </tr>
                                        <!-- Record 2 -->
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-success/15 text-success px-2.5 py-1.25 rounded-full text-xs">In Stock</span>
                                            </td>
                                        </tr>
                                        <!-- Record 3 -->
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-danger/15 text-danger px-2.5 py-1.25 rounded-full text-xs">Out of Stock</span>
                                            </td>
                                        </tr>
                                        <!-- Record 5 -->
                                        <tr>
                    ...
                    <div class="xl:col-span-5">
                        <div class="card h-full" data-table="" data-table-rows-per-page="5">
                            <div class="card-header">
                                <h4 class="card-title">
                                    Recent Orders
                                    <span class="text-default-400 text-sm font-normal ms-1">(186.25k Transactions)</span>
                                </h4>
                                <div>
                                    <a class="btn btn-sm border-default-300 hover:border-default-400 font-semibold" href="#">
                                        <i class="iconify tabler--cloud-upload"></i>
                                    ...
                                    <table class="table table-hover whitespace-nowrap w-full">
                                        ...
                                        <tbody class="text-nowrap">
                                            ...
                                            <tr>
                                                <td>#ORD-1023</td>
                                                <td>
                                                    <h5 class="font-semibold">John Carter</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1022</td>
                                                <td>
                                                    <h5 class="font-semibold">Emma Wilson</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1021</td>
                                                <td>
                                                    <h5 class="font-semibold">Michael Harris</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1020</td>
                                                <td>
                                                    <h5 class="font-semibold">Sophia Turner</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1019</td>
                                                <td>
                                                    <h5 class="font-semibold">Chris Evans</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1018</td>
                                                <td>
                                                    <h5 class="font-semibold">Ava Mitchell</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1017</td>
                                                <td>
                                                    <h5 class="font-semibold">Liam Parker</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1016</td>
                                                <td>
                                                    <h5 class="font-semibold">Isabella Rose</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1015</td>
                                                <td>
                                                    <h5 class="font-semibold">Oliver Brown</h5>
                                            ...
                                            <tr>
                                                <td>#ORD-1014</td>
                                                <td>
                                                    <h5 class="font-semibold">Charlotte Green</h5>
                        ...
                        <div class="grid xl:grid-cols-2 grid-cols-1 gap-base h-full">
                            <div class="card h-full">
                                ...
                                <div class="card-body pt-1.25">
                                    ...
                                    <div class="mt-5">
                                        <div class="p-2.5 mb-base border border-dashed border-default-300 rounded">
                                            <div class="md:flex items-center md:justify-between gap-2.5">
                                                ...
                                                <div class="ms-auto">
                                                    <h4 class="mt-1.25 font-semibold text-end text-base">25.9k</h4>
                                                    <span class="text-default-400 font-semibold text-xs uppercase">Order</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex items-center mb-2.5 gap-2.5">
                                            ...
                                            <p class="ms-auto">
                                                <span class="font-semibold">$48.6k</span>
                                                <span class="text-default-400">Revenue</span>
                                            </p>
                                        </div>
                                        <div class="flex items-center mb-2.5 gap-2.5">
                                            ...
                                            <p class="ms-auto">
                                                <span class="font-semibold">$26.4k</span>
                                                <span class="text-default-400">Revenue</span>
                                            </p>
                                        </div>
                                        <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow pb-7.5">
                                                <h5 class="text-md mb-1.25 font-semibold">New Orders Synced from Storefront</h5>
                                                <p class="mb-1.25 text-default-400">1,250 new customer orders were successfully imported from the online store.</p>
                                                <span class="text-primary font-semibold">By Olivia Green</span>
                                            </div>
                                        </div>
                                        <!-- End Item -->
                                        <!-- Item -->
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow pb-7.5">
                                                <h5 class="text-md mb-1.25 font-semibold">Payment Gateway Integration Updated</h5>
                                        ...
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow pb-7.5">
                                                <h5 class="text-md mb-1.25 font-semibold">Inventory Levels Auto-Synced</h5>
                                                <p class="mb-1.25 text-default-400">All product quantities were updated based on the latest warehouse data.</p>
                                                <span class="text-primary font-semibold">By Sophia Lee</span>
                                            </div>
                                        </div>
                                        <!-- End Item -->
                                        <!-- Item -->
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow pb-7.5">
                                                <h5 class="text-md mb-1.25 font-semibold">New Vendor Accounts Approved</h5>
                                                <p class="mb-1.25 text-default-400">Five new seller accounts were verified and added to the marketplace.</p>
                                                <span class="text-primary font-semibold">By Liam Johnson</span>
                                            </div>
                                        </div>
                                        <!-- End Item -->
                                        <!-- Item -->
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow pb-7.5">
                                                <h5 class="text-md mb-1.25 font-semibold">Refund Requests Reviewed</h5>
                                                <p class="mb-1.25 text-default-400">27 refund claims were processed successfully with zero pending disputes.</p>
                                                <span class="text-primary font-semibold">By Ethan Miller</span>
                                            </div>
                                        </div>
                                        <!-- End Item -->
                                        <!-- Item -->
                                        <div class="flex gap-x-5">
                                            ...
                                            <div class="grow">
                                                <h5 class="text-md mb-1.25 font-semibold">Summer Campaign Launched</h5>
...
<!-- Custom table -->
@endsection @section('scripts') @vite(['resources/js/pages/custom-table.js']) @vite(['resources/js/pages/dashboard-ecommerce.js']) @endsection
