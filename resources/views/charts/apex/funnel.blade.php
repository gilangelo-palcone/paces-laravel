@extends('shared.base', ['title' => 'Funnel Apexcharts']) @section('styles') @endsection @section('content')
<div class="wrapper">
...
@endsection @section('scripts') @vite(['resources/js/pages/chart-apex-funnel.js']) @endsection
