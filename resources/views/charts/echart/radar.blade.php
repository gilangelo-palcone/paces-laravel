@extends('shared.base', ['title' => 'Radar Echart']) @section('styles') @endsection @section('content')
<div class="wrapper">
...
<!-- E Charts Demo js -->
@endsection @section('scripts') @vite(['resources/js/pages/chart-echart-radar.js']) @endsection
