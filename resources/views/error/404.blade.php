@extends('shared.base', ['title' => '404 Error']) @section('styles') @endsection @section('content')
                ...
                <div class="card rounded-2xl">
                    <div class="card-body p-7.5">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-2 text-xl font-bold uppercase">Nothing Here</h3>
                            ...
                            <div class="mt-8 flex items-center justify-center gap-1.5">
                                <button class="btn bg-primary text-white hover:bg-primary-hover" onclick="window.location.href = 'index.html'">Back to Home</button>
