@extends('shared.base', ['title' => '408 Error']) @section('styles') @endsection @section('content')
            ...
            <div class="2xl:w-5/12 md:w-1/2 sm:w-2/3 w-full">
                ...
                <div class="card rounded-2xl">
                    <div class="card-body p-7.5">
                        <div class="mb-base flex flex-col items-center justify-center text-center">
                        ...
                        <div class="p-9 text-center">
                            <div class="from-primary my-4 bg-linear-to-r to-danger bg-clip-text text-7xl font-bold text-transparent">408</div>
                            ...
                            <div class="mt-8 flex items-center justify-center gap-1.5">
                                <button class="btn bg-primary text-white hover:bg-primary-hover" onclick="window.location.reload()">Try Again</button>
