@extends('shared.base', ['title' => '403 Error']) @section('styles') @endsection @section('content')
                    ...
                    <div class="card-body p-7.5">
                        ...
                        <div class="p-9 text-center">
                            ...
                            <div class="mt-9 flex items-center justify-center gap-1.5">
                                <button class="btn bg-primary text-white hover:bg-primary-hover" onclick="window.location.href = 'index.html'">Go to Dashboard</button>
                                <button class="btn border-secondary text-secondary hover:bg-secondary hover:text-white" onclick="window.history.back()">Back</button>
                            </div>
                        </div>
                    </div>
                </div>
