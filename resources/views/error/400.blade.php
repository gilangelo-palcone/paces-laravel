@extends('shared.base', ['title' => '400 Error']) @section('styles') @endsection @section('content')
<!-- Start Page Content here -->
<div class="flex min-h-screen items-center">
    <div class="container">
        <div class="flex justify-center lg:p-0 p-12.5">
            <div class="2xl:w-5/12 md:w-1/2 sm:w-2/3 w-full">
                ...
                <div class="card rounded-2xl">
                    <div class="card-body p-7.5">
                        ...
                        <div class="p-3 text-center">
                            <div class="from-primary my-4 bg-linear-to-r to-danger bg-clip-text text-7xl font-bold text-transparent">400</div>
                            ...
                            <div class="flex justify-center gap-3 mt-7.5">
                                <button class="btn border border-secondary text-secondary hover:text-white hover:bg-secondary" onclick="history.back()">Go Back</button>
                                <button class="btn bg-primary text-white hover:bg-primary-hover" onclick="window.location.href = 'index.html'">Back to Dashboard</button>
                            </div>
                        </div>
                    </div>
                </div>
