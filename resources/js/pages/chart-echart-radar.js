    ...
    options: () => ({
        radar: {
            ...
            splitArea: {
                show: true,
                areaStyle: {
                    color: [theme("light", 0.5), theme("light", 0), theme("light", 0.5), theme("light", 0), theme("light", 0.5)],
                },
            },
            splitLine: {
                lineStyle: {
                    color: [theme("default-300"), theme("default-300"), theme("default-300"), theme("default-300"), theme("default-300")],
                    width: 1,
                },
            },
            axisLine: {
                lineStyle: {
                    color: theme("default-300"), // Axis lines (from center to edges)
                },
            },
        },
        legend: {
                ...
                data: [
                    {
                        ...
                        areaStyle: {
                            color: theme("chart-primary", 0.5), // Blueish transparent
                        },
                        lineStyle: {
                            color: theme("chart-primary", 0.5),
                        },
                        itemStyle: {
                    ...
                    },
                    {
                        ...
                        areaStyle: {
                            color: theme("chart-secondary", 0.5), // Blueish transparent
                        },
                        lineStyle: {
                            color: theme("chart-secondary", 0.5), // Blueish transparent
                        },
...
new CustomEChart({
    ...
    options: () => ({
        ...
        legend: {
            ...
            pageIconColor: theme("default-400"), // Arrow button color
            pageTextStyle: {
                color: theme("default-400"), // Page number color
            },
            data: (function () {
                const list = []
                for (let i = 1; i <= 28; i++) {
