...
function format(d) {
    ...
    return (
        ...
        '<div class="col-md-4">' +
        '<h5 class="text-sm mb-1">Rating:</h5>' +
        "<div>" +
        d.rating +
        "</div>" +
        "</div>" +
        '<div class="col-md-4">' +
        '<h5 class="text-sm mb-1">Status:</h5>' +
        `<span class="badge rounded-none ${d.status === "Bullish" ? "bg-success/15 text-succes" : "bg-danger/15 text-danger"}">${d.status}</span>` +
        "</div>" +
        '<div class="col-md-4">' +
        '<h5 class="text-sm mb-1">Extra info:</h5>' +
