            ...
            $(customTemplateInput).typeahead(
                ...
                },
                {
                    ...
                    templates: {
                        ...
                        suggestion: (data) => `
                            <div>
                                <span class="font-medium">${data.value}</span> – ${data.year}
                            </div>
                        `,
                    },
                }
        ...
        if (multiDatasetInput) {
            $(multiDatasetInput).typeahead(
                ...
                },
                {
                    ...
                    display: "team",
                    templates: {
                        header: '<h5 class="league-name text-default-400 font-semibold border-bottom py-2">NBA Teams</h5>',
                    },
                },
                {
                    name: "nhl-teams",
                    ...
                    display: "team",
                    templates: {
                        header: '<h5 class="league-name text-default-400 font-semibold border-bottom py-2">NHL Teams</h5>',
                    },
                }
            )
        }
