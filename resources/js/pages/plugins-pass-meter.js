...
class PasswordMeter {
    ...
    initPasswordBox() {
        ...
        try {
            collapseInstance = new bootstrap.Collapse(container, {
                toggle: false,
            })
        } catch (err) {
...
//         // Create or get existing collapse instance
//         // const { element: collapseInstance } = HSCollapse.getInstance(container, true);
