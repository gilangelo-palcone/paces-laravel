        ...
        tooltip: {
            ...
            custom: function ({ series, seriesIndex, dataPointIndex, w }) {
                ...
                <div class="apexcharts-tooltip-candlestick px-3 py-2">
                    <div class="pb-2">Open: <span class="value font-semibold">${o}</span></div>
                    <div class="pb-2">High: <span class="value font-semibold">${h}</span></div>
                    <div class="pb-2">Low: <span class="value font-semibold">${l}</span></div>
                    <div>Close: <span class="value font-semibold">${c}</span></div>
                </div>
            `
                }
