    ...
    if (tableElement) {
        new DataTable(tableElement, {
            columns: [
                ...
                { title: "rating" },
                {
                    ...
                    render: function (data, type, row) {
                        var badgeClass = data === "Bullish" ? "bg-success/15 text-success" : "bg-danger/15 text-danger"
                        return `<span class="badge rounded-none ${badgeClass}">${data}</span>`
                    },
                },
            ],
            data: dataSet,
            language: {
                ...
                info: 'Showing <span class="font-semibold">_START_ </span> to <span class="font-semibold">_END_</span> of <span class="font-semibold">_TOTAL_</span> Companies', // Customize the "Showing" text
            },
        })
    }
})
