        ...
        series: [
            {
                ...
                axisLabel: { color: theme("default-400"), fontSize: 12 },
                detail: {
                    valueAnimation: true,
    ...
    options: () => ({
        tooltip: {
            ...
            formatter: (params) => {
                ...
                return `
                      <div>
                        <h6 class="fs-9 text-body-tertiary">
        ...
        series: [
            {
                ...
                axisLine: {
                    lineStyle: { width: 30, color: [[1, theme("light")]] },
                },
        ...
        series: [
            {
                ...
                axisLine: {
                    lineStyle: { width: 8, color: [[1, theme("light")]] },
                },
                splitLine: { show: false },
                axisTick: { show: false },
                axisLabel: { show: false },
